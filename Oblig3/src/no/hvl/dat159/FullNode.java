 ...
 * - Provide a limited UtxoMap to wallets that matches one particular
 *   address.
 */
public class FullNode {
	...
	public void mineAndAddGenesisBlock() {
		...
		CoinbaseTx coinbasetx = new CoinbaseTx(0, DateTimeUtil.getTimestamp() + " - hei hei.", wallet.getAddress());
	...
	public void mineAndAppendBlockContaining(Transaction tx) {
		...
		if(newBlock.isValid()) {
			...
			System.out.println("CoinbaseTC is invalid");
		}
		//else
			//up to you
	}
